...
type Settings struct {
	...
	HaproxyIntegration string `json:"haproxyIntegration,omitempty"`
...
type Account struct {
	...
	StatusLastUpdate string `json:"statusLastUpdate,omitempty"`
}
...
type Validation struct {
	...
	HttpOpnAutodiscovery        string `json:"http_opn_autodiscovery,omitempty"`
	HttpOpnInterface            string `json:"http_opn_interface,omitempty"`
	HttpOpnIpaddresses          string `json:"http_opn_ipaddresses,omitempty"`
	HttpHaproxyInject           string `json:"http_haproxyInject,omitempty"`
	...
	TlsalpnAcmeAutodiscovery    string `json:"tlsalpn_acme_autodiscovery,omitempty"`
	...
	DnsAzurednsManagedidentity  string `json:"dns_azuredns_managedidentity,omitempty"`
	...
	DnsDaInsecure               string `json:"dns_da_insecure,omitempty"`
	...
	DnsIspconfigInsecure        string `json:"dns_ispconfig_insecure,omitempty"`
	...
	DnsOpnsenseInsecure         string `json:"dns_opnsense_insecure,omitempty"`
	...
	DnsTransipTokenGlobalKey    string `json:"dns_transip_token_global_key,omitempty"`
...
type Action struct {
	...
	SftpModtime               string `json:"sftp_modtime,omitempty"`
	...
	RemoteSshPort             string `json:"remote_ssh_port,omitempty"`
	...
	AcmeSynologyDsmCreate     string `json:"acme_synology_dsm_create,omitempty"`
	...
	AcmeVaultKvv2             string `json:"acme_vault_kvv2,omitempty"`
	...
	AcmeZyxelGs1900Insecure   string `json:"acme_zyxel_gs1900_insecure,omitempty"`
	AcmeZyxelGs1900Reboot     string `json:"acme_zyxel_gs1900_reboot,omitempty"`
}
